...
function ReviewStar() {
  ...
  return (
    <div className="flex items-center ">
      ...
      <p className="ms-2 text-sm font-bold text-green-900">{workerRating === 0.0 ? ("No rating") : (workerRating)}</p>
      <span className="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
      <a href="#" className="text-sm font-medium text-gray-900 underline hover:no-underline">{workerReview} reviews</a>
    </div>
  )
}
