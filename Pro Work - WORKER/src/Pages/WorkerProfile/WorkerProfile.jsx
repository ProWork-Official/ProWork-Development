          ...
          <div className="border-b border-gray-300 pb-12 sm:px-8 ">
            ...
            <div className="mt-10 grid grid-cols-1  gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-2 sm:col-span-4 lg:col-span-2">
                <label className="block text-lg font-bold text-gray-900 mb-4">Owner's Aadhar Card & Pan Card</label> {/* Increased text size and weight */}
                <div className="mt-4 w-full flex flex-row flex-wrap gap-6 justify-center lg:justify-between"> {/* Added flex-wrap for responsiveness, adjusted gap */}
                  {/* Aadhar Front */}
                  <div className="flex-1 min-w-[180px] max-w-sm bg-white rounded-xl shadow-lg border border-gray-200 flex flex-col items-center p-4 transition-transform hover:scale-105"> {/* Increased max-w, shadow, padding */}
                    <img
                      ...
                      alt="Owner's Aadhar Card Front"
                      className="object-cover rounded-lg h-52 w-full border-2 border-gray-300" // Increased height, border thickness
                    />
                    <span className="mt-3 text-sm text-gray-800 font-bold">Aadhar Front</span> {/* Increased text size and weight */}
                  </div>
                  {/* Aadhar Back */}
                  <div className="flex-1 min-w-[180px] max-w-sm bg-white rounded-xl shadow-lg border border-gray-200 flex flex-col items-center p-4 transition-transform hover:scale-105"> {/* Increased max-w, shadow, padding */}
                    <img
                      src={WorkerFormData.AadharBack}
                      alt="Owner's Aadhar Card Back"
                      className="object-cover rounded-lg h-52 w-full border-2 border-gray-300" // Increased height, border thickness
                    />
                    <span className="mt-3 text-sm text-gray-800 font-bold">Aadhar Back</span> {/* Increased text size and weight */}
                  </div>
                  {/* Pan Card */}
                  <div className="flex-1 min-w-[180px] max-w-sm bg-white rounded-xl shadow-lg border border-gray-200 flex flex-col items-center p-4 transition-transform hover:scale-105"> {/* Increased max-w, shadow, padding */}
                    <img
                      ...
                      className="object-cover rounded-lg h-52 w-full border-2 border-gray-300" // Increased height, border thickness
                    />
                    <span className="mt-3 text-sm text-gray-800 font-bold">Pan Card</span> {/* Increased text size and weight */}
                  </div>
                </div>
              </div>
